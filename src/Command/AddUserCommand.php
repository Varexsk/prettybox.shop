...
class AddUserCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('isAdmin', '', InputArgument::REQUIRED,'If set the user is created as an administration')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $successMessage = sprintf('New user`s id: %s / Elapsed time %.2f ms / Consumed memory: %.2f MB',
            $user->getId(),
            $event->getDuration(),
            $event->getMemory()/1000/1000);
        $io->comment($successMessage);
